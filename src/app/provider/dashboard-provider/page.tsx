            ...
            <Card className="w-full sm:w-3/5 mb-4 sm:mr-2">
              ...
              <CardContent>
                <div className="flex flex-row justify-between">
                  <div className="text-2xl font-bold text-primaryProvider whitespace-nowrap">
                    $ 12320.86
                  </div>
                  <div className="text-2xl font-bold text-primaryProvider whitespace-nowrap sm:text-right">
                    + 70%
                  </div>
                </div>
              </CardContent>
          ...
          <Card className="w-full">
            <CardHeader className="pb-4">
              <div className="flex justify-between">
                ...
                <a
                  href="#"
                  className="text-muted-foreground hover:underline hover:decoration-gray-400"
                >
                  See All
                </a>
              </div>
        ...
        <Card className="mt-4 p-4 h-auto md:h-[320px] mx-auto">
          <CardHeader className="py-2 px-3">
            <div className="flex justify-between">
              ...
              <a
                href="#"
                className="whitespace-nowrap text-muted-foreground hover:underline hover:decoration-gray-400"
              >
                See All
              </a>
            </div>
