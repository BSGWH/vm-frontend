...
export default function Page() {
    ...
    return (
        <div className="w-full h-full grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-min px-4">
            <div className="col-span-1 md:col-span-3 h-8 mt-6 mb-4 flex justify-between items-center">
            ...
            <div className="col-span-1 md:col-span-2 flex flex-col items-center">
                <Card className="mt-4 p-4 h-auto md:h-[300px] w-full mx-auto">
            ...
            <div className="col-span-1 md:col-span-1">
                <Card className="mt-4 p-4 h-auto md:h-[300px] mx-auto">
            ...
            {/* Messages and Earning */}
            <div className="col-span-1 md:col-span-2">
                <Card className="m-4 p-4 h-auto md:h-[350px] mx-auto">
            ...
            <div className="col-span-1 md:col-span-1">
                <Card className="mt-4 p-4 h-auto md:h-[350px] mx-auto">
                    <CardHeader className="px-4 py-4">
