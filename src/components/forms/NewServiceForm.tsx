...
import {
  ...
  import {ServiceProviderTable} from "@/components/dashboardComponents/serviceComponents/ServiceProviderTable"
                    ...
                    <Select>
                        ...
                        <SelectContent>
                            <SelectGroup>
                                ...
                                <SelectItem value="service4">Wheel Alignments</SelectItem>
                                <SelectItem value="service5">Engine & Battery Services</SelectItem>
                                <SelectItem value="service6">Diagnostic Services</SelectItem>
                            </SelectGroup>
                        </SelectContent>
                    </Select>
                  </FormControl>
