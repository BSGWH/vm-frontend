...
export const Pricing = () => {
  return (
    <section id="pricing" className="py-12 sm:py-24 w-full" style={{ backgroundColor: "#2FA16D33" }} >
      <h2 className="text-3xl md:text-4xl font-bold text-center p-3" style={{ color : "black"}}>
        Get
