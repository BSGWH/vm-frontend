...
export function SigninForm() {
  ...
  return (
    <div className="flex h-screen w-full">
      <div className="hidden md:flex flex-col justify-between w-1/2 bg-black text-white pt-20"></div>
        ...
        <div className="w-full max-w-md p-8">
          <Card className="border-0 shadow-none bg-white dark:bg-gray-900 text-black dark:text-white">
            ...
            <CardContent className="space-y-4">
              ...
              <SubmitButton
                className="w-full bg-primaryCustomer hover:bg-primaryCustomer-hover text-white py-3 rounded"
                text="Sign In"
                loadingText="Loading"
              />
            </CardContent>
